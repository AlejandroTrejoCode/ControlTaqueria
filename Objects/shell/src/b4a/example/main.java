...
public static RemoteObject _input = RemoteObject.declareNull("anywheresoftware.b4a.agraham.dialogs.InputDialog");
public static RemoteObject _password = RemoteObject.createImmutable("");
public static b4a.example.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"AnimacionArriba",main.mostCurrent._animacionarriba,"Animaciones",main.mostCurrent._animaciones,"AnimacionFade",main.mostCurrent._animacionfade,"AnimacionFadeRojo",main.mostCurrent._animacionfaderojo,"BotonAcceder",main.mostCurrent._botonacceder,"BotonCancelar",main.mostCurrent._botoncancelar,"Input",main.mostCurrent._input,"LabelSeleccion",main.mostCurrent._labelseleccion,"PanelCarta",main.mostCurrent._panelcarta,"PanelLogin",main.mostCurrent._panellogin,"PanelRojo",main.mostCurrent._panelrojo,"PanelSombra",main.mostCurrent._panelsombra,"Password",main.mostCurrent._password,"SplashLogo",main.mostCurrent._splashlogo,"Starter",Debug.moduleToString(b4a.example.starter.class),"Usuarios",main.mostCurrent._usuarios};
}
}