...
//BA.debugLineNum = 6;BA.debugLine="PanelLogin.Width = 95%x"[splash/General script]
views.get("panellogin").vw.setWidth((int)((95d / 100 * width)));
...
//BA.debugLineNum = 8;BA.debugLine="PanelLogin.Left = 2.5%x"[splash/General script]
views.get("panellogin").vw.setLeft((int)((2.5d / 100 * width)));
...
//BA.debugLineNum = 13;BA.debugLine="SplashFooter.Width = 100%x"[splash/General script]
views.get("splashfooter").vw.setWidth((int)((100d / 100 * width)));
//BA.debugLineNum = 14;BA.debugLine="SplashFooter.Height = 8%y"[splash/General script]
views.get("splashfooter").vw.setHeight((int)((8d / 100 * height)));
//BA.debugLineNum = 15;BA.debugLine="SplashFooter.Top = 92%y"[splash/General script]
views.get("splashfooter").vw.setTop((int)((92d / 100 * height)));
//BA.debugLineNum = 16;BA.debugLine="SplashFooter.Left = 0%x"[splash/General script]
